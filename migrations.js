			    ...
			    "documents": [
			        {
			            ...
			            "fecha_inicio": moment(fechaahora).add(-5, 'hours').add(1, 'day').add(60, 'seconds'),
			            ...
			            "created_at": Date.now(),
			            "updated_at": Date.now(),
			            "producto":"57977ec07d0b67e41585cf96",
			            "tipo_subasta":"579781302f1fdc6817141bc7",
			            "user": "579a95c527fc04b8013c3ebd",
			        },
			        {
			            "titulo"	: "Samsung Galaxy S7 (Negro)",
			            "descripcion": "Galaxy celular",
			            "fecha_inicio": moment(fechaahora).add(-5, 'hours').add(1, 'day').add(55, 'seconds'),
			            "fecha_fin":"2016-08-04",
			            "shipping": true,
			            "estado": 2,
			            "destacado": true,
			            "created_at": Date.now(),
			            "updated_at": Date.now(),
			            "producto":"57977ec07d0b67e41585cf97",
			            "tipo_subasta":"579781302f1fdc6817141bc7",
			            "user": "579a95c527fc04b8013c3ebd",
			        },
			        {
			            "titulo"	: "Reloj Casio G-Shock (Negro)",
			            "descripcion": "Nuevo Reloj",
			            "fecha_inicio": moment(fechaahora).add(-5, 'hours').add(1, 'day').add(50, 'seconds'),
			            "fecha_fin":"2016-08-04",
			            "shipping": true,
			            "estado": 2,
			            "destacado": true,
			            "created_at": Date.now(),
			            "updated_at": Date.now(),
			            "producto":"57977ec07d0b67e41585cf98",
			            "tipo_subasta":"579781302f1fdc6817141bc7",
			            "user": "579a95c527fc04b8013c3ebd",
			        },
			        {
			            "titulo"	: "Samsung Audífono Bluetooth Level 3",
			            "descripcion": "Audifonos de la marca Samsung",
			            "fecha_inicio": moment(fechaahora).add(-5, 'hours').add(1, 'day').add(45, 'seconds'),
			            "fecha_fin":"2016-08-04",
			            "shipping": true,
			            "estado": 2,
			            "destacado": true,
			            "created_at": Date.now(),
			            "updated_at": Date.now(),
			            "producto":"57977ec07d0b67e41585cf99",
			            "tipo_subasta":"579781302f1fdc6817141bc7",
			            "user": "579a95c527fc04b8013c3ebd",
			        },
			        {
			            "titulo"	: "Tarjeta Steam Card $20 (Código Virtual)",
			            "descripcion": "Steam Card",
			            "fecha_inicio": moment(fechaahora).add(-5, 'hours').add(1, 'day').add(40, 'seconds'),
			            "fecha_fin":"2016-08-04",
			            "shipping": true,
			            "estado": 2,
			            "destacado": false,
			            "created_at": Date.now(),
			            "updated_at": Date.now(),
			            "producto":"57977ec07d0b67e41585cf9a",
			            "tipo_subasta":"579781302f1fdc6817141bc7",
			            "user": "579a95c527fc04b8013c3ebd",
			        },
			        {
			            "titulo"	: "Acer Notebook 14' Intel Core i5",
			            "descripcion": "Última generacion en notebooks",
			            "fecha_inicio": moment(fechaahora).add(-5, 'hours').add(1, 'day').add(35, 'seconds'),
			            "fecha_fin":"2016-08-04",
			            "shipping": true,
			            "estado": 2,
			            "destacado": true,
			            "created_at": Date.now(),
			            "updated_at": Date.now(),
			            "producto":"57977ec07d0b67e41585cf9b",
			            "tipo_subasta":"579781302f1fdc6817141bc7",
			            "user": "579a95c527fc04b8013c3ebd",
			        },
			        {
			            "titulo"	: "Sony PlayStation Vita (Wi-Fi)",
			            "descripcion": "Ultima generacion en consolas de juegos",
			            "fecha_inicio": moment(fechaahora).add(-5, 'hours').add(1, 'day').add(30, 'seconds'),
			            "fecha_fin":"2016-08-04",
			            "shipping": true,
			            "estado": 2,
			            "destacado": true,
			            "created_at": Date.now(),
			            "updated_at": Date.now(),
			            "producto":"57977ec07d0b67e41585cf9c",
			            "tipo_subasta":"579781302f1fdc6817141bc7",
			            "user": "579a95c527fc04b8013c3ebd",
			        },
			        {
			            "titulo"	: "Corsair Mousepad m3300",
			            "descripcion": "Un triste pad",
			            "fecha_inicio": moment(fechaahora).add(-5, 'hours').add(1, 'day').add(25, 'seconds'),
			            "fecha_fin":"2016-08-04",
			            "shipping": true,
			            "estado": 2,
			            "destacado": false,
			            "created_at": Date.now(),
			            "updated_at": Date.now(),
			            "producto":"57977ec07d0b67e41585cf9d",
			            "tipo_subasta":"579781302f1fdc6817141bc7",
			            "user": "579a95c527fc04b8013c3ebd",
			        },
			        {
			            "titulo"	: "Cm storm Octane Teclado",
			            "descripcion": "Un teclado con un diseño gamer",
			            "fecha_inicio": moment(fechaahora).add(-5, 'hours').add(1, 'day').add(20, 'seconds'),
			            "fecha_fin":"2016-08-04",
			            "shipping": true,
			            "estado": 2,
			            "destacado": false,
			            "created_at": Date.now(),
			            "updated_at": Date.now(),
			            "producto":"57977ec07d0b67e41585cf9e",
			            "tipo_subasta":"579781302f1fdc6817141bc7",
			            "user": "579a95c527fc04b8013c3ebd",
			        },
			        {
			            "titulo"	: "Hori Control Fighting Commander",
			            "descripcion": "No se que es, pero dice que sirve para ps3",
			            "fecha_inicio": moment(fechaahora).add(-5, 'hours').add(1, 'day').add(15, 'seconds'),
			            "fecha_fin":"2016-08-04",
			            "shipping": true,
			            "estado": 3,
			            "destacado": false,
			            "created_at": Date.now(),
			            "updated_at": Date.now(),
			            "producto":"57977ec07d0b67e41585cf9f",
			            "tipo_subasta":"579781302f1fdc6817141bc7",
			            "user": "579a95c527fc04b8013c3ebd",
			        },
			        {
			            "titulo"	: "Audífonos Skullcandy Ink'",
			            "descripcion": "Nada de SkullCandy tiene esto",
			            "fecha_inicio": moment(fechaahora).add(-5, 'hours').add(1, 'day').add(10, 'seconds'),
			            "fecha_fin":"2016-08-04",
			            "shipping": true,
			            "estado": 3,
			            "destacado": false,
			            "created_at": Date.now(),
			            "updated_at": Date.now(),
			            "producto":"57977ec07d0b67e41585cfa0",
			            "tipo_subasta":"579781302f1fdc6817141bc7",
			            "user": "579a95c527fc04b8013c3ebd",
			        }
