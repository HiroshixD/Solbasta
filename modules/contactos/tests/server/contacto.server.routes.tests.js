...
describe('Contacto CRUD tests', function () {
          ...
          .end(function (articleSaveErr, articleSaveRes) {
            ...
            agent.get('/api/articles')
              .end(function (articlesGetErr, articlesGetRes) {
                ...
                (articles[0].title).should.match('Contacto Title');
  ...
  it('should be able to get a list of articles if not signed in', function (done) {
    ...
    var articleObj = new Contacto(article);
  ...
  it('should return proper error for single article with an invalid Id, if not signed in', function (done) {
    ...
    request(app).get('/api/articles/test')
      .end(function (req, res) {
        // Set assertion
        res.body.should.be.instanceof(Object).and.have.property('message', 'Contacto is invalid');
  ...
  it('should be able to get single article, that a different user created, if logged in & verify the "isCurrentUserOwner" field is set to "false"', function (done) {
    ...
    _user.save(function (err, _user) {
      ...
      // Sign in with the user that will create the Contacto
      agent.post('/api/auth/signin')
        .send(credentials)
        .expect(200)
        .end(function (signinErr, signinRes) {
