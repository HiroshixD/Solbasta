(function () {
  ...
  describe('Contactos Route Tests', function () {
    ...
    beforeEach(inject(function ($rootScope, _ContactosService_) {
    ...
    describe('Route Config', function () {
      ...
      describe('View Route', function () {
        ...
        it('should attach an article to the controller scope', function () {
          expect($scope.vm.article._id).toBe(mockContacto._id);
        });
