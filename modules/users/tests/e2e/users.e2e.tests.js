...
describe('Users E2E Tests:', function () {
  ...
  describe('Signup Validation', function () {
    ...
    it('Should report a password with less than 10 characters long - "P@$$w0rd!"', function () {
      ...
      element(by.css('button[type=submit]')).click();
      // Password Error
      expect(element.all(by.css('.error-text')).get(0).getText()).toBe('El password must be at least 10 characters long.');
    });
    ...
    it('Should report a password with less than one special character - "Passw0rdss"', function () {
      ...
      element(by.css('button[type=submit]')).click();
      // Password Error
      expect(element.all(by.css('.error-text')).get(0).getText()).toBe('Hiro The password must contain at least one special character.');
    });
    ...
    it('Should report Email already exists', function () {
      ...
      element(by.css('button[type=submit]')).click();
      // Password Error
      expect(element.all(by.css('strong')).get(0).getText()).toBe('El email ya está registrado');
    });
  ...
  describe('Change Password Settings Validation', function () {
    ...
    it('Should report a password with less than one special character - "Passw0rdss"', function () {
      ...
      element(by.css('button[type=submit]')).click();
      // Password Error
      expect(element.all(by.css('.error-text')).get(0).getText()).toBe('Hiroshi The password must contain at least one special character.');
    });
