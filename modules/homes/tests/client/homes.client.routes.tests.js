  ...
  describe('Homes Route Tests', function () {
    ...
    describe('Route Config', function () {
      ...
      describe('List Route', function () {
        var liststate;
        beforeEach(inject(function ($state) {
          liststate = $state.get('homes.list');
        }));
        ...
        it('Should have template', function () {
          expect(liststate.templateUrl).toBe('modules/homes/client/views/list-homes.client.view.html');
        });
      });
      ...
      describe('Handle Trailing Slash', function () {
        ...
        it('Should remove trailing slash', inject(function ($state, $location, $rootScope) {
          ...
          expect($location.path()).toBe('/homes');
          expect($state.current.templateUrl).toBe('modules/homes/client/views/list-homes.client.view.html');
        }));
      });
