  ...
  describe('Reminders Route Tests', function () {
    ...
    describe('Route Config', function () {
      ...
      describe('List Route', function () {
        var liststate;
        beforeEach(inject(function ($state) {
          liststate = $state.get('reminders.list');
        }));
        ...
        it('Should have template', function () {
          expect(liststate.templateUrl).toBe('modules/reminders/client/views/list-reminders.client.view.html');
        });
      });
      ...
      describe('Handle Trailing Slash', function () {
        ...
        it('Should remove trailing slash', inject(function ($state, $location, $rootScope) {
          ...
          expect($location.path()).toBe('/reminders');
          expect($state.current.templateUrl).toBe('modules/reminders/client/views/list-reminders.client.view.html');
        }));
      });
